...
namespace Elite
{
	...
	public interface IGfx
	{
		...
		void gfx_draw_colour_line_xor(int x1, int y1, int x2, int y2, int line_colour);

		void gfx_draw_triangle(int x1, int y1, int x2, int y2, int x3, int y3, int col);

		void gfx_display_text(int x, int y, string txt);

		void gfx_display_colour_text(int x, int y, string txt, int col);

		void gfx_display_centre_text(int y, string str, int psize, int col);
