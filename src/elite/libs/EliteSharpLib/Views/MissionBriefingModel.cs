...
internal sealed record MissionBriefingModel(
    string Headline,
    ...
    bool ShowPortrait)
{
    ...
    /// </summary>
    internal static MissionBriefingModel Nothing { get; } = new(string.Empty, [], false);

    /// <summary>
    /// Gets a value indicating whether a headline is set above the message.
    /// </summary>
    internal bool HasHeadline => !string.IsNullOrEmpty(Headline);
}
