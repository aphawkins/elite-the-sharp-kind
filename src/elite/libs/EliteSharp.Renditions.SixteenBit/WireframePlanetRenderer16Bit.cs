...
/// </summary>
internal sealed class WireframePlanetRenderer16Bit : WireframePlanetRendererBase
{
    internal WireframePlanetRenderer16Bit(IViewSurface surface, bool hasCrater)
