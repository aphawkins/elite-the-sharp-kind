...
/// and a shaded shade.
/// </summary>
internal sealed class FractalPlanetRenderer16Bit : FractalPlanetRendererBase
{
    ...
    internal FractalPlanetRenderer16Bit(IViewSurface surface, IRandomSource random)
        : base(surface, random)
    {
