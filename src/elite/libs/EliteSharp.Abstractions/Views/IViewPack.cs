...
/// composition root.
/// <para>
/// A pack holds no state: it is handed an <see cref="IViewSurface"/> and
/// builds views on it, and the game keeps what it built. Unlike a mission, a
/// pack is not optional - the tier the commander configured has to be
/// installed or there is nothing to draw with.
/// </para>
/// </summary>
public interface IViewPack
{
    /// <summary>
    /// Gets the tier this pack draws. The game loads every pack it finds and
