...
internal sealed class PilotView : IView
{
    ...
    public void Draw()
    {
        ...
        {
            _draw.Graphics.DrawTextCentre(358, "Galactic Hyperspace", nameof(FontType.Small), EliteColors.White);
        }
        else if (_space.HyperCountdown > 0)
        {
            _draw.Graphics.DrawTextCentre(358, $"Hyperspace - {_space.HyperName}", nameof(FontType.Small), EliteColors.White);
        }
    }
    ...
    internal void DrawViewName(string name)
        => _draw.Graphics.DrawTextCentre(_draw.Top + 10, name, nameof(FontType.Small), EliteColors.White);
}
