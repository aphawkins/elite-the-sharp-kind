...
namespace Elite.Engine.Ships
{
    internal sealed class Transporter : IShip
    {
        ...
        public ShipFace[] Faces { get; } =
        {
            ...
            new(Colour.Blue1, new(-0x4B, 0x20, 0x4F), new[] {  13, 12,  8,  9 }),
            new(Colour.Blue1, new( 0x4B, 0x20, 0x4F), new[] {  15, 14, 10, 11 }),

            new(Colour.Grey1, new(-0x08, 0x22, 0x0B), new[] { 8, 12,  7 }),
            new(Colour.Grey2, new( 0x08, 0x22, 0x0B), new[] { 7, 15, 11 }),
            ...
            new(Colour.White1, new(-0x08, 0x20, 0x03), new[] {  18, 20 /*, 19 */ }),
            new(Colour.White1, new(-0x08, 0x20, 0x03), new[] {  20, 21 /*, 18 */ }),
            new(Colour.White1, new(-0x08, 0x20, 0x03), new[] { 20, 19 /*, 21 */ }),

            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 23, 22 /*, 26 */ }),
            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 25, 26 /*, 23 */ }),
            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 24, 22 /*, 25 */ }),
            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 24, 23 /*, 22 */ }),
            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 28, 27 /*, 23 */ }),
            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 25, 27 /*, 22 */ }),
            new(Colour.White1, new( 0x08, 0x20, 0x03), new[] { 27, 26 /*, 22 */ }),
        };
