...
{
    internal sealed class Boulder : IShip
    {
        ...
        {
            new(Colour.Grey3, new(-0x0F,-0x03, 0x08), new[] { 0, 4, 5 }),
            new(Colour.Grey1, new(-0x07, 0x0C, 0x1E), new[] { 0, 5, 1 }),
            new(Colour.Grey2, new( 0x20,-0x2F, 0x18), new[] { 1, 5, 2 }),
            new(Colour.Grey3, new(-0x03,-0x27,-0x07), new[] { 2, 5, 3 }),
            new(Colour.Grey1, new(-0x05,-0x04,-0x01), new[] { 3, 5, 4 }),

            new(Colour.Grey2, new( 0x31, 0x54, 0x08), new[] { 1, 6, 0 }),
            new(Colour.Grey3, new( 0x70, 0x15,-0x15), new[] { 2, 6, 1 }),
            new(Colour.Grey1, new( 0x4C,-0x23,-0x52), new[] { 3, 6, 2 }),
            new(Colour.Grey2, new( 0x16, 0x38,-0x89), new[] { 4, 6, 3 }),
            new(Colour.Grey1, new( 0x28, 0x6E,-0x26), new[] { 6, 4, 0 }),
        };
