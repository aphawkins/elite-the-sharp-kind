    ...
    internal class Market : IView
    {
        ...
        public void Draw()
        {
            ...
            foreach (var stock in _trade.stock_market)
            {
                ...
                _gfx.DrawTextRight(285, y, $"{stock.Value.current_price:N1}", GFX_COL.GFX_COL_WHITE);

                _gfx.DrawTextRight(365, y, stock.Value.current_quantity > 0 ? $"{stock.Value.current_quantity}" : "-", GFX_COL.GFX_COL_WHITE);
                _gfx.DrawTextLeft(365, y, stock.Value.current_quantity > 0 ? stock.Value.units : "", GFX_COL.GFX_COL_WHITE);
        ...
        public void HandleInput()
        {
            ...
            {
                _highlightedStock = (StockType)Math.Clamp((int)_highlightedStock - 1, 0, _trade.stock_market.Count - 1);
            }
