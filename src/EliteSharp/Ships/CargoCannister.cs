...
namespace EliteSharp.Ships
{
    internal sealed class CargoCannister : ShipBase
    {
            ...
            : base(draw)
        {
            ...
            Faces =
            [
                new(FastColors.Grey, new(0x60, 0x00, 0x00), [4, 0, 1, 2, 3]),

                new(FastColors.DarkGrey, new(0x00, 0x29, 0x1E), [5, 6, 1, 0]),
                new(FastColors.LightGrey, new(0x00, -0x12, 0x30), [6, 7, 2, 1]),
                new(FastColors.DarkerGrey, new(0x00, -0x33, 0x00), [7, 8, 3, 2]),
                new(FastColors.LightGrey, new(0x00, -0x12, -0x30), [8, 9, 4, 3]),
                new(FastColors.DarkerGrey, new(0x00, 0x29, -0x1E), [9, 5, 0, 4]),

                new(FastColors.Grey, new(-0x60, 0x00, 0x00), [8, 7, 6, 5, 9]),
            ];
            Lines =
            [
                new(31, 1, 0, 0, 1),
