...
namespace EliteSharp.Ships
{
    internal sealed class EscapeCapsule : ShipBase
    {
            ...
            : base(draw)
        {
            ...
            Faces = new ShipFace[]
            {
                new(EColors.LighterRed,      new(0x34, 0x00, -0x7A), new[] { 3, 1, 2 }),
                new(EColors.LightRed, new(0x27, 0x67, 0x1E), new[] { 0, 3, 2 }),
                new(EColors.Red,    new(0x27, -0x67, 0x1E), new[] { 0, 1, 3 }),
                new(EColors.RedOrange,    new(0x70, 0x00, 0x00), new[] { 0, 2, 1 }),
            };
            Lines = new ShipLine[]
            {
                new(31,  2,  3,  0,  1),
