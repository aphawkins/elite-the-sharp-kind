...
namespace EliteSharp.Ships
{
    internal sealed class Asteroid : ShipBase
    {
            ...
            : base(draw)
        {
            ...
            Faces =
            [
                new(FastColors.DarkerGrey, new(0x09, 0x42, 0x51), [5, 0, 6]),
                new(FastColors.LightGrey, new(0x09, -0x42, 0x51), [2, 5, 6]),
                new(FastColors.DarkGrey, new(-0x48, 0x40, 0x1F), [6, 0, 1]),

                new(FastColors.DarkerGrey, new(-0x40, -0x49, 0x2F), [2, 6, 1]),
                ...
                new(FastColors.DarkerGrey, new(-0x42, 0x3B, -0x27), [1, 0, 7]),
                ...
                new(FastColors.DarkerGrey, new(0x3A, -0x66, -0x33), [3, 2, 8]),
                new(FastColors.DarkerGrey, new(0x51, 0x09, -0x43), [4, 3, 7]),
