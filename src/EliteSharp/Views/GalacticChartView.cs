...
namespace EliteSharp.Views
{
    internal sealed class GalacticChartView : IView
    {
        ...
        public void Draw()
        {
            ...
            _draw.Graphics.DrawLine(new(0 + _draw.Offset, 36 + 258), new(_draw.ScannerRight, 36 + 258), FastColors.White);
            ...
            {
                _draw.Graphics.DrawPixel(pixel, FastColors.White);
            }

            // Cross
            centre = new(_gameState.Cross.X + _draw.Offset, _gameState.Cross.Y);

            _draw.Graphics.DrawLine(new(centre.X - 8, centre.Y), new(centre.X + 8, centre.Y), FastColors.LighterRed);
            _draw.Graphics.DrawLine(new(centre.X, centre.Y - 8), new(centre.X, centre.Y + 8), FastColors.LighterRed);
