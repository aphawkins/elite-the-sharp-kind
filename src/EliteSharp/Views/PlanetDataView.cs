...
namespace EliteSharp.Views
{
    internal sealed class PlanetDataView : IView
    {
        ...
        public void Draw()
        {
            ...
            {
                _graphics.DrawTextLeft(16, 42, "Distance:", Colour.Green);
                _graphics.DrawTextLeft(140, 42, $"{_distanceToPlanet:N1} Light Years", Colour.White);
            }

            _graphics.DrawTextLeft(16, 74, "Economy:", Colour.Green);
            _graphics.DrawTextLeft(140, 74, _economyType[_hyperPlanetData.Economy], Colour.White);
            _graphics.DrawTextLeft(16, 106, "Government:", Colour.Green);
            _graphics.DrawTextLeft(140, 106, _governmentType[_hyperPlanetData.Government], Colour.White);
            _graphics.DrawTextLeft(16, 138, "Tech Level:", Colour.Green);
            _graphics.DrawTextLeft(140, 138, $"{_hyperPlanetData.TechLevel + 1}", Colour.White);
            _graphics.DrawTextLeft(16, 170, "Population:", Colour.Green);
            _graphics.DrawTextLeft(140, 170, $"{_hyperPlanetData.Population:N1} Billion {_planet.DescribeInhabitants(_gameState.HyperspacePlanet)}", Colour.White);
            _graphics.DrawTextLeft(16, 202, "Gross Productivity:", Colour.Green);
            _graphics.DrawTextLeft(140, 202, $"{_hyperPlanetData.Productivity} Million Credits", Colour.White);
            _graphics.DrawTextLeft(16, 234, "Average Radius:", Colour.Green);
            _graphics.DrawTextLeft(140, 234, $"{_hyperPlanetData.Radius} km", Colour.White);
