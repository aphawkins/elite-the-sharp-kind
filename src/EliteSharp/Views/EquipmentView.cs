    ...
    internal sealed class EquipmentView : IView
    {
        ...
        public void Draw()
        {
            ...
            for (int i = 0; i < _equipmentStock.Length; i++)
            {
                ...
                {
                    _draw.Graphics.DrawRectangleFilled(new(2 + _draw.Offset, y + 1), 508, 15, FastColors.LightRed);
                }

                FastColor colour = _equipmentStock[i].CanBuy ? FastColors.White : FastColors.LightGrey;
            ...
            _draw.Graphics.DrawTextLeft(new(16 + _draw.Offset, 340), $"Cash: {_trade.Credits:N1} Credits", FastColors.White);
        }
