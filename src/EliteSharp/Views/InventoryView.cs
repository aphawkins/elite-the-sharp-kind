...
namespace EliteSharp.Views
{
    internal sealed class InventoryView : IView
    {
        ...
        public void Draw()
        {
            ...
            _draw.Graphics.DrawTextLeft(new(16 + _draw.Offset, 50), "Fuel:", EColors.Green);
            _draw.Graphics.DrawTextLeft(new(70 + _draw.Offset, 50), $"{_ship.Fuel:N1} Light Years", EColors.White);

            _draw.Graphics.DrawTextLeft(new(16 + _draw.Offset, 66), "Cash:", EColors.Green);
            _draw.Graphics.DrawTextLeft(new(70 + _draw.Offset, 66), $"{_trade.Credits:N1} Credits", EColors.White);
