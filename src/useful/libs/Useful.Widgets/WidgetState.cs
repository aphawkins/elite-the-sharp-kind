...
/// <summary>
/// Which of a widget's looks to draw. The cursor being on a row and a row
/// being unavailable are the two things a menu screen varies, so they are
/// states rather than flags: a widget is in exactly one of them.
/// </summary>
public enum WidgetState
{
    ...
    /// <summary>
    /// The cursor is on this widget, but it is not available. A real state
