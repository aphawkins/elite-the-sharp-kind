...
/// <summary>
/// Opens a window showing every widget and lets the keyboard drive the ones
/// that take input.
/// <para>
...
/// <c>GAME_FRAME_DUMP_DIR</c> facilities, which are how a widget can be
/// driven and photographed without injecting keys at the OS.
/// </para>
/// </summary>
internal static class Program
{
    private const string Title = "Useful Widgets - Gallery";
