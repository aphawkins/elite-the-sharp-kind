...
public class SoftwareGraphicsTests
{
    ...
    {
        // Arrange
        using SoftwareGraphics graphics = new(5, 5, new SoftwareAssetLoader(new SoftwareAssetLocator()), DoAssert);
    ...
    {
        // Arrange
        using SoftwareGraphics graphics = new(5, 5, new SoftwareAssetLoader(new SoftwareAssetLocator()), (_) => { });
    ...
    private static Mock<ISoftwareAssetLoader> ArrangeAssets(string filename)
    {
        ...
        SoftwareAssetLoader assetLoader = new(moqAssetLocator.Object);

        Mock<ISoftwareAssetLoader> moqAssetLoader = new();
        moqAssetLoader.Setup(x => x.LoadImages())
            .Returns(assetLoader.LoadImages());
        moqAssetLoader.Setup(x => x.LoadFonts())
            .Returns([]);

        return moqAssetLoader;
    }
}
